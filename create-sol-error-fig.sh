...
create_fig() {
    ...
    for d in * ; do
        convert +append $d ../field-total/$d ../../$dirfanal/$d
    done
    cd ../..;
...
dir1="slices-zoom-u"
dir2="slices-error-zoom-u"
dirfanal="slices-sol-error-u"
create_fig

dir1="slices-zoom-v"
dir2="slices-error-zoom-v"
dirfanal="slices-sol-error-v"
create_fig

dir1="slices-zoom-p"
dir2="slices-error-zoom-p"
dirfanal="slices-sol-error-p"
create_fig
